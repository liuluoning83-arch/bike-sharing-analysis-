...
网页还提供“高级小时级预测（需要历史需求）”。它使用前一小时、前一天同一小时、前一周同一小时和过去 24 小时平均租赁量，因此在测试集达到 MAE 33.045、RMSE 56.583、R² 0.934。该模式必须输入真实已发生的租赁量，不适用于完全没有历史数据的首次预测。
...
它们分别表示前一小时、前一天同一小时、前一周同一小时的真实租赁量，以及过去 24 小时真实租赁量的平均值。
